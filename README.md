...
**Languages**<br>
[![Languages](https://skillicons.dev/icons?i=c,cpp,java,py,js,go&perline=6)](https://skillicons.dev)<br>
`C` `C++` `Java` `Python` `JavaScript` `Go`

**Frontend**<br>
[![Frontend](https://skillicons.dev/icons?i=html,react,tailwind,figma&perline=6)](https://skillicons.dev)<br>
`HTML` `React` `Tailwind CSS` `Figma`

**Backend & Databases**<br>
[![Backend](https://skillicons.dev/icons?i=nodejs,mysql,postgres&perline=6)](https://skillicons.dev)<br>
